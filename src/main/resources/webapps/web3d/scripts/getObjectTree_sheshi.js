 ...
 function getSelectPbTypes() {
  ...
  function LoadAllCustomTrees() {
  		 	...
  		 	// initialize the tree
  $("#jstree_div_jixie").jstree({
 		"core": {
 			'data': {
 				'url': '/task/modelview/getjixietypetree/',
 				'data': function(node) {
 					return {
 						'id': node.id
 					};
  ...
  $("#jstree_div_sheshi").jstree({
 		"core": {
 			'data': {
 				'url': '/task/modelview/getsheshitypetree/',
 				'data': function(node) {
 					return {
 						'id': node.id
 					};
  ...
  $("#jstree_div_hazard").jstree({
 	...
 	$("#jstree_div_pbtype").jstree({
 		...
 		"plugins": ["themes", "json_data", "checkbox"],
 	 	...
 	 	// initialize the tree
 	$("#jstree_div_pbmajor").jstree({
 		"core": {
 			'data': {
 				'url': '/task/modelview/getpbmajortree/',
 				'data': function(node) {
 					return {
 						'id': node.id
 					};
	...
	$("#jstree_div_worktype").jstree({
 		"core": {
 			'data': {
 				'url': '/task/modelview/getworktypetree/',
 				'data': function(node) {
 					return {
 						'id': node.id
 					};
