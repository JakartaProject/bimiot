  ...
  var Panel = function(
    ...
    /////////////////////////////////////////////////////////////
	  var html = "";	   
		...
		html += "<div><label  value= '空间查看' style='margin-bottom:4px;padding: 2px 4px;background-color:#00A779;opacity: 0.70;' onMouseOver='this.title=this.innerText'>空间查看</label></div>";
		html += "</div>";
