...
//		});
	...
	Autodesk.Viewing.Viewer3D.prototype.drawAnnotationString = function(objectId, drawString) {
		...
		it.enumNodeFragments(dbId, function(fragId) {
			...
			var position = bBox.center();
			var screenPoint = _self.worldToScreen(position, viewer.getCamera());
...
//				});
			...
			if (_index%2==0) {
				screenPoint.x= screenPoint.x+630;
			} else{
				screenPoint.x= screenPoint.x-150;
			}
