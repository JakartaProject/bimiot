...
Autodesk.ADN.Viewing.Extension.SampleTaskGoal = function (viewer, options) {
  ...
  var Panel = function(
    ...
    var html = `<div class="pbwell-simaple">
						...
						<div><label  value="目标未完成" style="background-color:#0000FF;padding:3px;" onMouseOver="this.title=this.innerText">目标未完成</label></div>
						<div><label value="目标完成" style="background-color:#FF9900;padding:3px;" onMouseOver="this.title=this.innerText">目标完成</label></div>
						<div><label  value="之前完成" style="background-color:#00FF00;padding:3px;" onMouseOver="this.title=this.innerText">之前完成</label></div>
			   </div>`;
